...
export function PaymentTypesTab({ data, t, fmt, isSuperAdmin, openModal, expandedPaymentType, setExpandedPaymentType, setEditingPaymentType, handleDeletePaymentType }) {
  {activeTab==="payments" && (
            <div>
